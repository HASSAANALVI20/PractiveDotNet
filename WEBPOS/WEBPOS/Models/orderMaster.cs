...
namespace WEBPOS.Models
{
    ...
    public partial class orderMaster
    {
        ...
        public orderMaster()
        {
            this.logMaster = new HashSet<logMaster>();
        }
        ...
        public Nullable<int> orderUsedbyCounter { get; set; }
        public int branchId { get; set; }
        public Nullable<bool> isUpdate { get; set; }
        public string voucherNo { get; set; }
        public Nullable<bool> punchFromBranch { get; set; }
        public Nullable<bool> isTransfer { get; set; }
        public string dispatchTime { get; set; }
        public Nullable<double> wrCommssion { get; set; }
        public Nullable<double> wrCommission { get; set; }
    
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<logMaster> logMaster { get; set; }
    }
}
